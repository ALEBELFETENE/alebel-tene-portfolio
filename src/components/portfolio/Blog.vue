<template>
  <div class="blog-page" :class="themeClass">
    <LayoutHeader />
      ...
      <div class="container">
        ...
        <div class="blog-content">
          ...
          <div class="blog-sidebar">
            <!-- Categories Widget -->
            <UiCard class="sidebar-widget animate-fade-in-up" style="animation-delay: 0.8s">
              <template #header>
            ...
            <!-- Popular Posts -->
            <UiCard class="sidebar-widget animate-fade-in-up" style="animation-delay: 1s">
              <template #header>
                <div class="widget-header">
            ...
            <!-- Newsletter -->
            <UiCard class="sidebar-widget newsletter-widget animate-fade-in-up" style="animation-delay: 1.2s">
              <template #header>
                <div class="widget-header">
              ...
              <div class="newsletter-content">
                ...
                <div class="newsletter-form">
                  ...
                  />
                  <UiButton size="small" class="newsletter-btn" @click="subscribeNewsletter">
...
:global(.dark) .blog-page {
  background: linear-gradient(135deg, #0f0f23 0%, #1a1a2e 50%, #16213e 100%);
}

:global(.light) .blog-page {
  background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 50%, #e2e8f0 100%);
  color: #334155;
}

:global(.light) .blog-title {
...
:global(.light) .sidebar-widget,
:global(.light) .view-controls {
  background: rgba(255, 255, 255, 0.9);
  border-color: rgba(226, 232, 240, 0.8);
  color: #334155;
}

:global(.light) .post-title,
:global(.light) .widget-header h3 {
  color: #1e293b;
}

:global(.light) .post-excerpt,
:global(.light) .blog-subtitle {
  color: #64748b;
}
</style>