    ...
    <div class="mobile-menu" :class="{ 'mobile-menu--open': mobileMenuOpen }">
      ...
      <div class="mobile-theme-toggle">
        <button class="theme-toggle theme-toggle--mobile" @click="toggleTheme">
          ...
          <span class="theme-toggle-text">{{ themeToggleText }}</span>
        </button>
      </div>
    </div>
  </header>
...
export default {
  ...
  setup() {
    ...
    const themeToggleText = computed(() => {
      return themeStore.theme === 'dark' ? 'Light Mode' : 'Dark Mode'
    })
...
:root {
  ...
  --header-scrolled-bg: rgba(15, 23, 42, 0.98);
  
  --text-primary: #f8fafc;
  --text-secondary: #cbd5e1;
  --text-muted: #94a3b8;
  
  --logo-bg: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);
  --logo-shadow: 0 8px 32px rgba(99, 102, 241, 0.3);
...
[data-theme="light"] {
  ...
  --logo-bg: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%);
  --logo-shadow: 0 8px 32px rgba(99, 102, 241, 0.2);
