...
export default {
      ...
      default: () => [
        {
          ...
          image: getProjectImage('ecommerce'),
          ...
          githubUrl: 'https://github.com/ALEBELFETENE/ecommerce-platform',
          favorite: false
        },
        {
          id: 2,
          ...
          progress: 100,
          demoUrl: 'https://demo.example.com',
          githubUrl: 'https://github.com/ALEBELFETENE/task-management',
          favorite: true
        },
        {
          id: 3,
          ...
          progress: 100,
          demoUrl: 'https://demo.example.com',
          githubUrl: 'https://github.com/ALEBELFETENE/weather-analytics',
          favorite: false
        },
        {
          id: 4,
          ...
          progress: 100,
          demoUrl: 'https://demo.example.com',
          githubUrl: 'https://github.com/ALEBELFETENE/api-gateway',
          favorite: false
        },
        {
          id: 5,
          title: 'Portfolio Website',
          description: 'Modern, responsive portfolio website built with Vue.js and Vite, featuring smooth animations, dark mode, and optimized performance.',
          image: getProjectImage('portfolio'),
          technologies: ['Vue.js 3', 'Vite', 'Tailwind CSS', 'GSAP', 'Three.js'],
          category: 'Frontend',
          duration: '2 weeks',
          linesOfCode: '5K+',
          features: '8+',
          progress: 100,
          demoUrl: 'https://alebelfetene.com',
          githubUrl: 'https://github.com/ALEBELFETENE/portfolio',
          favorite: true
        }
      ]
    }
  ...
  setup(props) {
    ...
    onMounted(() => {
      ...
      if (projectsGrid.value) observer.observe(projectsGrid.value)
    })
...
function getProjectImage(type) {
  const images = {
    ecommerce: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    task: 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    weather: 'https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    api: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80',
    portfolio: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80'
  }
  return images[type] || getPlaceholderImage()
}

// Fallback placeholder image
function getPlaceholderImage() {
  return 'data:image/svg+xml;base64,'
}
</script>
